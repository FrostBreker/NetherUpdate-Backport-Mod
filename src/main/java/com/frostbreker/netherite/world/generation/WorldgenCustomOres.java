package com.frostbreker.netherite.world.generation;
...
public class WorldgenCustomOres implements IWorldGenerator {
    ...
    public WorldgenCustomOres() {
        ANCIENT_DEBRIS = new WorldGenMinable(ModBlock.ANCIENT_DEBRIS.getDefaultState(), 4, BlockMatcher.forBlock(Blocks.NETHERRACK));
        ANCIENT_DEBRIS2 = new WorldGenMinable(ModBlock.ANCIENT_DEBRIS.getDefaultState(), 2, BlockMatcher.forBlock(Blocks.NETHERRACK));
    }
