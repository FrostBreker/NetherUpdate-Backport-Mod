...
public class BlockNetherDiamond extends BlockOre
{

    public BlockNetherDiamond(Material rock)
    {
    ...
    {
        return this == BlockMod.nether_diamond_ore ? Items.diamond : Item.getItemFromBlock(this);
    }
    ...
    public int getExpDrop(IBlockAccess p_149690_1_, int p_149690_5_, int p_149690_7_)
    {
        if (this.getItemDropped(p_149690_5_, rand, p_149690_7_) != Item.getItemFromBlock(this))
        {
            ...
            if (this == BlockMod.nether_diamond_ore)
            {
